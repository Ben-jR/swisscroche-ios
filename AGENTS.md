...
- `swisscroche/Resources/SwissList.json` (BAKOM 090x premium-rate prefixes) is the **single** list file: bundled in the app *and* published by GitHub Pages at the same repo path. Never add a second copy — the two would drift apart silently. See `list/README.md`.
